...
export default function TimerScreen() {
  ...
  const [isReflectionModalVisible, setIsReflectionModalVisible] =
    useState(false);
    ...
    >
      <SafeAreaView style={{ flex: 1, alignItems: "center" }}>
        ...
        <View style={styles.headerRow}>
          ...
          >
            <View
              style={[styles.dot, { backgroundColor: Colors.dark.primary }]}
            />
        ...
        <Modal
          visible={isModuleListVisible}
          transparent
          animationType="fade"
          onRequestClose={() => setIsModuleListVisible(false)}
        >
          <View style={styles.modalOverlay}>
            ...
            >
              <Text style={[styles.modalHeader, { color: Colors.dark.text }]}>
                Your Modules
              </Text>
              ...
              <TouchableOpacity
                onPress={() => setIsModuleListVisible(false)}
          ...
          <View style={styles.modalOverlay}>
            ...
            >
              ...
              <TextInput
                style={[
                  styles.input,
                  { color: "white", borderBottomColor: Colors.dark.primary },
                ]}
        ...
        >
          <View style={styles.modalOverlay}>
            ...
            >
              ...
              <Text
                style={{ color: Colors.dark.textSecondary, marginBottom: 20 }}
              >
                ...
                {moods.map((m) => (
                  <TouchableOpacity
                    ...
                    style={{
                      ...
                      borderRadius: 15,
                      backgroundColor:
                        mood === m ? Colors.dark.primary : "transparent",
                      borderWidth: 1,
              ...
              <TouchableOpacity
                style={[
                  ...
                  {
                    width: "100%",
                    backgroundColor: mood ? Colors.dark.primary : "#555",
                  },
                ]}
                onPress={saveSession}
                disabled={!mood}
